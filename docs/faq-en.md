...
Please refer to: [#371](https://github.com/libaxuan/ChatGPT-Libaxuan-Web/issues/371)

## Why is my Token consumed so fast?
> Related discussion: [#518](https://github.com/libaxuan/ChatGPT-Libaxuan-Web/issues/518)
